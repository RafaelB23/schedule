...
export declare type HorarioCreateFormValidationValues = {
    ...
    id_maestro?: ValidationFunction<string>;
    id_materia?: ValidationFunction<string>;
};
...
export declare type HorarioCreateFormOverridesProps = {
    ...
    id_maestro?: PrimitiveOverrideProps<TextFieldProps>;
    id_materia?: PrimitiveOverrideProps<TextFieldProps>;
} & EscapeHatchProps;
