...
export default function MateriaCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setMateria_key(initialValues.materia_key);
    setName(initialValues.name);
    setLenguage(initialValues.lenguage);
    setModality(initialValues.modality);
    setErrors({});
  };
  const validations = {
    materia_key: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createMateria.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MateriaCreateForm")}
      {...rest}
    >
      <TextField
        label="Materia key"
