...
export default function MaestroCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setMaestro_key(initialValues.maestro_key);
    setErrors({});
  };
  const validations = {
    name: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createMaestro.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MaestroCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
